      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              "flex h-auto min-h-9 w-full items-center justify-between rounded-md border border-input-border bg-input p-1 [&_svg]:pointer-events-auto",
              className,
            )}
          >
            ...
            <CommandList>
              ...
              <CommandGroup>
                ...
                >
                  <div
                    className={cn(
                      "me-2 flex h-4 w-4 items-center justify-center rounded-sm border border-primary dark:border-input-border",
